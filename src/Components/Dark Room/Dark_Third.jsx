...
Command: npx gltfjsx@6.5.3 public/models/Dark Room/Dark_Third.glb 
*/
...
export function DarkThird(props) {
  const { nodes, materials } = useGLTFWithKTX2('/models/Dark Room/Dark_Third.glb')
